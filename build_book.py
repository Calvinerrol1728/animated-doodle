...
Usage:
    python3 build_book.py [--out princess_elara_and_the_secret_garden_of_stars.pdf]
...
def main() -> int:
    ...
    ap.add_argument("--pages", default="pages", help="directory of page images")
    ap.add_argument(
        "--out",
        default="princess_elara_and_the_secret_garden_of_stars.pdf",
    ...
    rendered[0].save(
        ...
        author="A Little Story About Kindness, Courage, and Wonder",
    )
